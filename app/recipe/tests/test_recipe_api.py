...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_create_recipe_with_existing_ingredient(self):
        ...
        payload = {
            ...
            'time_minutes': 20,
            'price': '10',
            'ingredients': [{'name': 'Tomatoes'}, {'name': 'Cheese'}]
        }
        res = self.client.post(RECIPES_URL, payload, format='json')
    ...
    def test_filter_by_ingredients(self):
        ...
        r1 = create_recipe(user=self.user, title='Alfredo Pasta')
        r2 = create_recipe(user=self.user, title='Caesar Salad')
        ingr1 = Ingredient.objects.create(user=self.user, name='Chicken')
        ingr2 = Ingredient.objects.create(user=self.user, name='Salad')
